<?php
$effects = array(
  'zenFadeInUp', 'zenFadeInRight', 'zenFadeInLeft', 'zenFadeInUpBig', 'zenFadeInRightBig','zenFadeInLeftBig',
);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Story Box - Zen Example</title>
...
<div class="jumbotron">
  <div class="container">
    <h2 class="text-primary text-center" data-sb="fadeInLeftBig" data-sb-hide="fadeOutUp">Story Box - Zen Example</h2>
    <h3 class="text-success text-center" data-sb="fadeInLeftBig" data-sb-hide="fadeOutUp">Bringing your Themes & Templates the power to be always <span class="label label-primary">ZEN</span></h3>
    <h3 class="text-danger text-center" data-sb="fadeInLeftBig" data-sb-hide="fadeOutUp">Your Themes Deserve To Offer a Smooth & Relaxing Experience</h3>
    <br/>
    <div class="row">
      <div class="col-sm-2">
